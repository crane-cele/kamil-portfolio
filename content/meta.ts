...
const pageMeta: PageMeta = {
  home: {
    title: "",
    description:
      "Hey, I am Kamil Krutul. A Front-end Developer/React Developer from India who loves to design and code. I use React.js or Next.js to build the web application interfaces and the functionalities. At the moment, I am pursuing my Bachelor's degree in Computer Science.",
    image: "https://imgur.com/KeJgIVl.png",
    keywords: "portfolio jatin, portfolio j471n",
  },
  utilities: {
    title: "Utilities",
    description:
